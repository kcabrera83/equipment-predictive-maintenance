...
def test_models():
    results = {}
    results['failure'] = evaluate_model(os.path.join(MODEL_DIR, 'failure_classifier.pkl'), X, y)
    results['rul_estimator'] = evaluate_model(os.path.join(MODEL_DIR, 'rul_estimator.pkl'), X, y)
    return results
